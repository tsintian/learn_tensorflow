...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr  2 20:10:04 2018
...
y = tf.placeholder(tf.float64, shape=[None,num_classes], name="labels")
...
with tf.name_scope('accuracy'):
    correct_prediction = tf.equal(tf.arg_max(y, 1), tf.arg_max(output, 1))
...
with tf.Session() as sess:
    ...
    for i in range(10000):
        ...
        print("Iter " + str(i) + ", Minibatch Loss=" +
              ...
              "{:.5f}".format(acc))
        if i % 10:
            # Calculate accuracy for 123 MNIST test images and add to summaries
