...
# Give a folder as an argument with '--log_dir' to save
...
# Create a directory for Tensorboard variables if there is not.
...
def read_data(filename):
    ...
    with zipfile.ZipFile(filename) as f:
        ...
        content = f.read(f.namelist()[0]).split()
...
# Filling 4 gloabal variables:
# data -  list of codes (Integers from 0 to vacabulary_zie - 1). This is the original text but words are replaced by
#          their codes.
